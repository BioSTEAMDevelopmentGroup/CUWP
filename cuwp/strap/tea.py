...
from biorefineries.tea import CellulosicEthanolTEA as STRAPTEA
__all__ = (
    'STRAPTEA',
    'create_baseline_tea',
)

def create_baseline_tea(sys, OSBL_units=None, cls=None, years=30):
    ...
    tea = cls(
        system=sys, 
        IRR=0.20, 
        duration=(2025, 2025 + years),
        depreciation='MACRS7', 
        income_tax=0.21, #switch from 35 on 8/1/2025
