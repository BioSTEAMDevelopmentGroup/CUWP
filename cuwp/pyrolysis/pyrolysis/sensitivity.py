...
def _create_model(context_sys, settings, tea):
    ...
    # def GWP_allocation():
    #     GWP = 'GWP 100yr'
    #     bst.F.Tire_Stream.set_CF(GWP, 0)
    ...
    feedstock = bst.F.Tire_Stream      # Es con el ID de la corriente 
    ...
    @model.parameter(
        ...
        distribution='triangular')
    def set_tire_price(tire_price):
        feedstock.price = tire_price
...
def run_montecarlo(PC , file_ps, file_corr,  settings,  N_samples = 5000): 
    ...
    # create system again
    context_sys, tea, NPV , IRR_val, _ , _ = create_system(processing_capacity=PC)
    # create model
